...
ABBREVIATIONS = {
    ...
    "cipro": "ciprofloxacin",
    "levo": "levofloxacin",
    "dolo": "paracetamol",          # Dolo 650 brand
    "crocin": "paracetamol",        # Crocin brand
    "combiflam": "ibuprofen",       # Combiflam brand
    "augmentin": "amoxicillin",     # Augmentin brand
...
def check_interactions(drug_ids: List[int]) -> List[Dict]:
    ...
    Uses pharmacological class overlap.
    """
    if len(drug_ids) < 2:
        return []
    ...
    # Gather pharm classes for each drug
    drug_classes: Dict[int, List[str]] = {}
    for did in drug_ids:
